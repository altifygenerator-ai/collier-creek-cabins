      ...
      <div className="container creek-grid">
        <Reveal className="creek-copy">
          ...
          <p>
            ...
            fishing, and exploring. Guests can enjoy the water, the rock banks,
            the wooded setting, and the quiet outdoor space right off the property.
          </p>
        ...
        <Reveal delay={0.12} className="creek-photo-stack creek-photo-stack-v3">
          <img className="creek-large" src={images.creek} alt="Clear Collier Creek" />
          <img className="creek-small" src={images.fish} alt="Fish caught in Collier Creek" />
          <div className="creek-note">
            <strong>Quiet creek days</strong>
